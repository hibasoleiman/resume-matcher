...
This module establishes the tool-use + Pydantic pattern that scorer.py also
follows. Read this file first and the other will make sense quickly — they
are variations on the same three beats:
